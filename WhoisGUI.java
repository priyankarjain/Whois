...
public class WhoisGUI extends JFrame{
	...
	private JPanel initRecordType(){
		...
		p.add(this.makeRadioButton("Organisation"));
	...
	private JPanel initSearchFields(){
		...
		JRadioButton any = new JRadioButton("All",true);
		any.setActionCommand("All");
		searchIn.add(any);
		p.add(any);

		p.add(this.makeRadioButton("Name"));
		p.add(this.makeRadioButton("Mailbox"));
		p.add(this.makeRadioButton("Handle"));
	...
	private class Lookup extends SwingWorker<String, Object>{
		...
		protected String doInBackground() throws Exception{
			...
			else if(searchForLabel.equals("Organisation"))
